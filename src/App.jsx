  ...
  return (
    <>
      <div className="box_container">
        ...
        <br />
        <h1>Meet the honor students</h1> <br />
        <p className="long">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti
          saepe nobis esse iusto soluta adipisci, quaerat qui in, magni
          dignissimos amet quibusdam expedita dolore ipsa debitis est omnis nisi
          praesentium. Porro, cum placeat? Odio incidunt quas minus animi
          possimus facere voluptatem aliquid dolor, accusamus quaerat, molestias
          soluta veritatis iusto. Iusto, maxime mollitia modi eligendi ratione
          possimus voluptates dolores cum fuga. Laborum at impedit placeat autem
          voluptatibus. Labore cupiditate et numquam sapiente dolore alias
          doloribus est tempore, expedita doloremque voluptas, vitae pariatur
          molestiae aliquid itaque eos officia maxime voluptatem qui? Veniam
          magni nemo ut perspiciatis architecto fugit ad adipisci optio ab.
        </p>
